...
import { loginFeatures } from "@/components/login/data";
import { TbWorld } from "react-icons/tb";
import Accreditations from "@/app/main/Accreditations";
import LoginFooter_1 from "./LoginFooter_1";
import LoginFooter_2 from "./LoginFooter_2";
        ...
        >
          ...
          <div className="w-full max-w-md space-y-5 2xl:space-y-8">
            ...
            <div className="text-center lg:text-left">
              <h2 className=" lg:text-2xl xl:text-3xl font-semibold text-gray-900">
                {activeTab === "email" ? " Welcome Back!" : "OTP Login"}
              </h2>
              <p className="text-[12px] xl:text-[14px] text-gray-500 mt-2">
                {activeTab === "email"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="w-full pl-10 pr-10 py-3 rounded-lg border border-gray-200 outline-none text-gray-600
          focus:border-login-footer focus:ring-1 focus:ring-login-footer transition text-sm"
                    />
                ...
                <div className="flex items-center justify-between text-xs font-medium">
                  ...
                  <Link
                    ...
                    className="text-login-footer hover:underline"
                  >
                    Forgot Password?
                  </Link>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-[#111162] hover:bg-opacity-95 cursor-pointer text-white rounded-lg font-medium text-sm shadow-md transition-all duration-150 mt-2"
                >
                  Sign In
                </button>
              </form>
