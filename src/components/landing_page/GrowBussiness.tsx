...
import { TbPlaneDeparture, TbWorld } from "react-icons/tb";
    ...
    <div className="flex-1 min-w-0 bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
      ...
      <div className="px-3 py-1.5 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
        <span className="text-[8px] text-slate-400 flex items-center gap-1">
          <span className="w-3 h-3 rounded-full border border-slate-400 inline-flex items-center justify-center text-[6px]">i</span>
          All flight information is provided in real-time and subject to change.
        </span>
        <span className="text-[8px] text-slate-400">Data provided by Roaming Bangladesh</span>
      </div>
    </div>
  );
}
  ...
  return (
    <section className="mt-5 max-w-350 mx-auto w-full font-sans select-none">
      <div className="flex items-center gap-6 xl:gap-8">
        ...
        {/* ── LEFT: Grow your business content ── */}
        <div className="h-full flex flex-col justify-center rounded-2xl shrink-0 w-[200px] xl:w-[240px]">
          <div className="text-xl xl:text-2xl font-semibold text-secondary mb-3 tracking-tight leading-tight">
            <h2>Grow your business</h2>
            <h2>
              with <span className="text-primary">roaming</span>
            </h2>
          </div>

          <div className="text-primary text-base flex flex-col lg:text-[15px] xl:text-[16px] font-medium xl:leading-relaxed mb-3">
            <p>Join hundre of travel businesses that trust</p>
            <span>roaming for their travel needs</span>
            <span>Let&apos;s build success together</span>
          </div>

          <button
            className="w-fit inline-flex items-center text-[14px] xl:text-[16px] gap-2 bg-primary text-white font-medium px-6 py-2 rounded-md
            transition-all duration-200 hover:opacity-90 active:scale-95 shadow-sm cursor-pointer"
          >
            Become a Partner
        ...
        {/* ── RIGHT: Live Airport Information ── */}
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-3 mb-5">
            <div className="w-[400px] flex items-center gap-2 border border-slate-200 rounded-md px-3 py-2 bg-white shadow-sm">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="w-44 flex-shrink-0 bg-white rounded-xl shadow-sm border border-slate-100 p-3 flex flex-col gap-3">
              <div className="flex items-start gap-2">
                <TbWorld className="text-[#1a1f5e] w-5 h-5 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  className="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center hover:bg-slate-200 transition-colors cursor-pointer"
                  title="Refresh"
                >
