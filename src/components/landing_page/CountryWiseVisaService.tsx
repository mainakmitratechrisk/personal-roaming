...
import { HOTEL_IMAGES } from "./data";

const CountryWiseVisaService = () => {
    ...
    <section className=" py-2  font-sans select-none max-w-350 mx-auto w-full">
      <div className="flex flex-col md:flex-row items-stretch gap-6  relative">
        ...
        <div className="w-full md:w-[30%] flex flex-col justify-center pr-4 space-y-2">
          <h2 className="lg:text-[18px] xl:text-xl font-semibold text-secondary mb-3 tracking-tight">
            Country-wise Visa Services
          </h2>
          <div className="text-primary text-base md:text-[15px] xl:text-[16px] leading-relaxed">
            <p> Hassle-free visa processing for </p>
            <span>180+ countries with expert support.</span>
          </div>
          <button
...
export default CountryWiseVisaService;
